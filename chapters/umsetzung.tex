...
\end{figure}
\parencite{tpl}
\subsection{Blocking-Queue}\label{sec:blockingq}
\begin{lstlisting}[caption={Implementierung Blocking Q - V1, siehe MyBlockingQV1.cs}, label={lst:blockingV1}, captionpos=b]
...
\end{lstlisting}
\subsection{Verwendung von Bordmitteln}
